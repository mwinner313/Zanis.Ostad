...
export default {
  ...
  computed: {
    panel() {
      ...
      console.log(user)
      if (user.roles.some(x => x.toLowerCase() === "admin"))
        return "/admin/dashboard";
      if (user.roles.some(x => x.toLowerCase() === "teacher"))
        return "/teacher/dashboard";
      if (user.roles.some(x => x.toLowerCase() === "editor"))
