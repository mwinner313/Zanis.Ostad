          ...
          <li v-if="res.status===statuses.success">
            <div class='flash success'>
              ...
              <div class='inside'>
                ...
                <div>
                  <h2>پرداخت موفق!</h2>
                  <p class="text-center">تا چند لحطه دگ به صفحه چیزایی که خریدید میرید</p>
                </div>
                  ...
                  <svg viewBox='0 0 84 84'>
                    <g fill='none'>
                      ...
                      <path
                        ...
                        stroke-width='5' stroke='#C46465'></path>
                ...
                <figure class='icon'>
                  <svg viewBox='0 0 84 84'>
                    <g fill='none'>
                      ...
                      <path
                        d='M30,62 C33.0710678,65.0710678 37.3137085,66.9705627 42,66.9705627 C46.6862915,66.9705627 50.9289322,65.0710678 54,62'
                        stroke-width='5' stroke='#E1C55E'></path>
    ...
    methods: {
      ...
      async confirm() {
        ...
        setTimeout(() => {
          ...
          this.message = this.res.status === statuses.success ? 'پرداخت موفق' : 'پرداخت ناموفق';
