<template>
  <el-dialog width="60%" @close="$emit('close')" :visible.sync="dialogVisible">
    <div slot="title">
      <p>
        {{course.title}}
        <el-button
          class="float-right"
          @click="editingCourseItem={courseId,order:0}"
        ...
        <small>
          ...
          {{ course.createdOn | moment("jYYYY/jM/jD HH:mm") }}
        </small>
      </p>
    </div>
    <el-alert
...
import CourseUpdateDialog from "../../teacher/courses/course-edit-dialog.vue";
