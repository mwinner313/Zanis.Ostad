<template>
  <el-dialog :title="item.title" :visible.sync="dialogVisible" width="40%" @closed="$emit('close')">
    <el-form ref="form" :model="form">
      ...
      <el-form-item prop="type">
        <el-checkbox
          ...
          label="به روز رسانی پیام ادمین درباره دوره"
          name="type"
        ></el-checkbox>
      </el-form-item>
  ...
  methods: {
    submit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          axios
            .patch("/api/courses/change_approval_status", {
              courseApprovalStatus: this.form.courseApprovalStatus,
