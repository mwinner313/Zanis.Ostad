        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fields_Colleges_CollegeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamSampleFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamSampleFiles_Semesters_SemesterId",
            ...
            migrationBuilder.CreateTable(
                name: "LessonExamMappings",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    LessonId = table.Column<long>(nullable: false),
                    ExamSampleFileId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonExamMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LessonExamMappings_ExamSampleFiles_ExamSampleFileId",
                        column: x => x.ExamSampleFileId,
                        principalTable: "ExamSampleFiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LessonExamMappings_Lessons_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateTable(
                name: "StudentExamSampleMappings",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentExamSampleMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentExamSampleMappings_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentExamSampleMappings_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherLessonMappings", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeacherLessonMappingId = table.Column<long>(nullable: false),
                    CourseTitleId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.TeacherLessonMappingId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentCourseMappings", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentCourseMappings_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamSampleFiles_SemesterId",
                table: "ExamSampleFiles",
                column: "SemesterId");

            migrationBuilder.CreateIndex(
                name: "IX_Fields_CollegeId",
                table: "Fields",
                column: "CollegeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonExamMappings_ExamSampleFileId",
                table: "LessonExamMappings",
                column: "ExamSampleFileId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonExamMappings_LessonId",
                table: "LessonExamMappings",
                column: "LessonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentExamSampleMappings_LessonId",
                table: "StudentExamSampleMappings",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentExamSampleMappings_StudentId",
                table: "StudentExamSampleMappings",
                column: "StudentId");
